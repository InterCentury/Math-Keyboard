...
```
This repository contains an "Auto-Hotkey" file for making it easier to use math & physics symbols.It's really frustating in windows to use math symbols.To solve this issue, I made an "Auto
```
